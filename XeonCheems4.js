...
//antilink youtube video by Mr_Z
...
//antilink youtube channel by Mr_Z
...
│⸙͎ ᴾⁱⁿᵍ⚡ ↳ ${latensie.toFixed(4)} 𝚖𝚜

│⸙͎ ᶜᵃˡˡ ᴹᵉ → ${global.botname}

│⸙͎ ᴴᵒˡᵈᵉʳ➛ ${global.ownername}
╰───────────────✨`
...
break
	...
	reply(mess.wait)
            ...
            if (!args[0]) reply(`Use ${prefix}gitclone repo link\nExample: https://github.com/I4MBetAZ`)
...
XeonBotInc.sendMessage(from, { react: { text: `${global.reactmoji}`, key: m.key }})
	                let btn = [{
                        ...
                        let buttonmenu = [
        	{ urlButton: { displayText: `Yₜ 📌`, url : `${websitex}` } },
            { urlButton: { displayText: `ɢɪᴛ 📝`, url: `${botscript}` } },
            { quickReplyButton: { displayText: `ᴛᴀʀʀɪꜰ 📓`, id: 'allmenu'} },
            { quickReplyButton: { displayText: `ᴛᴀʀɪꜰꜰ ʟɪꜱᴛ 📓`, id: 'command'} },
            { quickReplyButton: { displayText: `ʜᴏʟᴅᴇʀ 🤴🏻`, id: 'owner'} }
        	]
...
await XeonBotInc.send5ButImg(from, `╔═══════✪「 HOLDER 」	
╠ ${prefix}self
╠ ${prefix}public
╠ ${prefix}antitag
...
╠ ${prefix}request
╠ ${prefix}report [bug]
╚═════════════✪` + '' + ' ', `${botname}`,unicorn, [{"urlButton": {"displayText": "ʏᴛ 📌","url": `${websitex}`}},{"urlButton": {"displayText": "ɢɪᴛ 📝","url": `${botscript}`}},{"quickReplyButton": {"displayText": "ɢɪᴛ 📝","id": 'donate'}},{"quickReplyButton": {"displayText": "ʜᴏʟᴅᴇʀ 🤴🏻","id": 'owner'}}] )
break
case 'ownermenu':
	   if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
